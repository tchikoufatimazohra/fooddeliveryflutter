        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FoodTitleWidget(
                  productName: "Healthy Brunch ",
                  productPrice: "\500da",
                  productHost: "zolilate healthyfood"),
              SizedBox(
                height: 15,
              ),
              AddToCartMenu(),
...
class DetailContentMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Text(
        'Mangeons bien mangeaons healthy , C est l heure davoir votre brunch en healthy \' la box contiet les aliments selon votre choix, pancake à base d avoine des boules énergetiques...et plein dautres composante surtout healthy.',
        style: TextStyle(
            fontSize: 14.0,
